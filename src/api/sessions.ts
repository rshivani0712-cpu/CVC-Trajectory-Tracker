...
export const PATIENT_PROFILES: PatientBodyType[] = [
  {
    ...
    name: 'Patient 01 — Obese Male (Elevated BMI)',
  ...
  },
  {
    ...
    name: 'Patient 02 — Obese Female (High Adiposity)',
  ...
  },
  {
    ...
    name: 'Patient 03 — Slender Female (Lean Build)',
  ...
  },
  {
    ...
    name: 'Patient 04 — Slender Male (Slender Male)',
    cohort: 'Prominent Musculature • Slender Male',
    category: 'standard',
    ...
    ijvLumenDia: 12.8,
    description: 'Slender male build with prominent musculature and minimal adipose tissue. Palpable clavicle and sternocleidomastoid triangle. Optimal baseline reference scenario.',
...
export const MOCK_SESSIONS: SessionResult[] = [
  ...
  },
  {
    ...
    traineePgy: 'PGY-2',
    patientProfileId: 'p2',
    patientProfileName: 'Patient 02 (Slender Male)',
    siteName: 'Right Internal Jugular Vein (IJV)',
    score: 94,
    classification: 'GOOD_TECHNIQUE',
    performanceLevel: 'PROFICIENT',
  ...
  },
  {
    ...
    traineePgy: 'PGY-3',
    patientProfileId: 'p4',
    patientProfileName: 'Patient 04 (Slender Female)',
    siteName: 'Right Internal Jugular Vein (IJV)',
    score: 91,
    classification: 'GOOD_TECHNIQUE',
    performanceLevel: 'PROFICIENT',
